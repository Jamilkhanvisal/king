...
print('\n\033[1;33m join my WHATS APP groph');time.sleep(1)
os.system('https://chat.whatsapp.com/JrjvjZSfEqsEspftDHKDdn')
...
def approval():
  ...
  sxb = 'YASIR'
  try:
    httpCaht = requests.get('https://raw.githubusercontent.com/JAMIL VISALo1/approvedone/main/JAMIL').text
    if id in httpCaht:
   ...
   #   print('\033[1;37m----------------------------------------------')
      ...
      print ("       Status  : \033[1;91mTrail\033[1;37m\n \033[1;31m\033[1;42m[+] Note: If You Are Free User come to jaomi\033[0;0m")
   #   print(" Other Countries : 5$ for Weekly  "#)
 #     print(" Other Countries : 15$ For Monthly")
    #  print('\033[1;37m----------------------------------------------')
 #     print(" Easypaisa  Number     : +93708509223")
  #    print(" Trust Wallet Address : 0xb785952B2825366c8756fb65520F7Df8e0D145bD ")
      input('\033[1;37m Press Enter For Contact To Admin ')
      tks = ('Hello%20Yasir%20Sir%20!%20Please%20Approve%20My%20Key%20The%20AFG.PRO%20Key%20Is%20:%20'+id);os.system('am start https://wa.me/+93708509223?text='+tks)
      time.sleep(1)
      approval()
  except:
    sys.exit()
